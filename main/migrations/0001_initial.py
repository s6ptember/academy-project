    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blocks', to='main.course', verbose_name='Курс')),
            ],
            options={
                'verbose_name': 'Блок',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.PositiveIntegerField(default=0, verbose_name='Порядок')),
                ('block', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subblocks', to='main.block', verbose_name='Блок')),
            ],
            options={
